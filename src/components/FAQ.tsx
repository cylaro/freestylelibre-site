...
const faqs = [
  ...
  {
    question: "Где купить фристайл либре в Воронеже?",
    answer:
      "Выберите модель в каталоге, оформите заказ онлайн и укажите удобный способ получения. Доступен самовывоз по согласованию и доставка по России."
  }
];
