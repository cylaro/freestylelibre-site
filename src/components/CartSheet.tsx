  ...
  return (
    <>
      <motion.div
        ...
        className="fixed bottom-[calc(env(safe-area-inset-bottom)+0.75rem)] sm:bottom-8 lg:bottom-12 right-3 sm:right-8 z-40"
      >
        <Button 
          size="icon" 
          className="h-14 w-14 sm:h-16 sm:w-16 rounded-full shadow-none ring-1 ring-black/5 bg-primary hover:bg-primary/90 transition-all"
